...
{
public:
  /// Generate display fields for a certain instance based on its cached tags
  /// Each rule plugin has the chance to fill any field in the series, study, and patient fields.
  /// The way these generated fields will be used is defined by \sa mergeDisplayFieldsForInstance
  virtual void getDisplayFieldsForInstance(const QMap<QString, QString> &cachedTagsForInstance, QMap<QString, QString> &displayFieldsForCurrentSeries,
    QMap<QString, QString> &displayFieldsForCurrentStudy, QMap<QString, QString> &displayFieldsForCurrentPatient)=0;
  ...
  /// Used when merging the original database content with the display fields generated by the rules.
